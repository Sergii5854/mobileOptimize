!function (e) {
    var a = function () {
        ...
        var e = "s", s = {
            ...
            for (var r = new Date(e.getTime() - a).getTime(), n = e.getTime() + a, o = new Date(r).getTimezoneOffset(), u = r, t = null; u < n - i;) {
            ...
            for (var r = function (a) {
                ...
                return r = t(e, i, r, a)
            }, n = {}, o = a.olson.dst_rules.zones, u = o.length, A = s.AMBIGUITIES[i], c = 0; c < u; c++) {
                var m = o[c], l = r(o[c]);
                "N/A" !== l && (n[m.name] = l)
            }
